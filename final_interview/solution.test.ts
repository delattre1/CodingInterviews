...
describe("Crypto", () => {
  ...
  it("chunkenize string", () => {
    expect(Crypto.chunkenize("abcdef", 2)).toEqual(["ab", "cd", "ef"]);
  });

  it("chunkenize non-perfect string", () => {
    expect(Crypto.chunkenize("abcdefg", 2)).toEqual(["ab", "cd", "ef", "g"]);
  });
